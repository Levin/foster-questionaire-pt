defmodule FosterWeb.Router do
  ...
  scope "/", FosterWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{FosterWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", FosterWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{FosterWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", FosterWeb do
    ...
    live_session :current_user,
      on_mount: [{FosterWeb.UserAuth, :mount_current_user}] do
